...
IMAGE_DIR="../public/images/noaa/geocolor/10848"  # Chemin relatif au répertoire d'images local
JS_FILE="../src/data/images.js"  # Chemin relatif où le fichier JS sera généré
...
# Extraire les fichiers .jpg contenant "GOES16-ABI-FD-GEOCOLOR-10848"
grep -oE 'href="([^"]*GOES16-ABI-FD-GEOCOLOR-10848[^"]*\.jpg)' index.html | sed 's/^href="//' > image_list.txt
...
while IFS= read -r image; do
  ...
  echo "  '/images/noaa/geocolor/10848/$image'," >> "$JS_FILE"
done < image_list.txt
