...
IMAGE_DIR="mnt/data/imageryapp/images/noaa/geocolor/678"  # Chemin relatif au répertoire d'images local
JS_FILE="../src/data/geocolor678.js"  # Chemin relatif où le fichier JS sera généré
...
grep -oE 'href="([^"]*GOES16-ABI-FD-GEOCOLOR-678[^"]*\.jpg)' index.html | sed 's/^href="//' > image_list.txt
...
while IFS= read -r image; do
  ...
  echo "  '/mnt/data/imageryapp/images/noaa/geocolor/678/$image'," >> "$JS_FILE"
done < image_list.txt
