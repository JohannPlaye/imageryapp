...
IMAGE_DIR="mnt/data/imageryapp/images/noaa/nearircirrus/678"  # Chemin relatif au répertoire d'images local
...
while IFS= read -r image; do
  ...
  echo "  '/mnt/data/imageryapp/images/noaa/nearircirrus/678/$image'," >> "$JS_FILE"
done < image_list.txt
