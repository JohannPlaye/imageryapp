...
IMAGE_DIR="mnt/data/imageryapp/images/noaa/nearircirrus/5424"  # Chemin relatif au répertoire d'images local
JS_FILE="../src/data/nearIRCirrus5424.js"  # Chemin relatif où le fichier JS sera généré
...
# Extraire les fichiers .jpg contenant "GOES16-ABI-FD-04-5424"
grep -oE 'href="([^"]*GOES16-ABI-FD-04-5424[^"]*\.jpg)' index.html | sed 's/^href="//' > image_list.txt
...
while IFS= read -r image; do
  ...
  echo "  '/mnt/data/imageryapp/images/noaa/nearircirrus/5424/$image'," >> "$JS_FILE"
done < image_list.txt
