...
$IMAGE_DIR = "../public/images/noaa/geocolor/678"  # Chemin relatif au répertoire d'images local
$JS_FILE = "../src/data/images678.js"  # Chemin relatif où le fichier JS sera généré
...
Select-String -Path "index.html" -Pattern 'href="([^"]*GOES16-ABI-FD-GEOCOLOR-678[^"]*\.jpg)' | 
...
Get-Content "image_list.txt" | ForEach-Object {
    ...
    "`t'/images/noaa/geocolor/678/$image'," | Add-Content -Path $JS_FILE
}
