...
IMAGE_DIR="mnt/data/imageryapp/images/noaa/AirMassRGB/FD/1808"  # Chemin relatif au répertoire d'images local
...
while IFS= read -r image; do
  ...
  echo "  '/mnt/data/imageryapp/images/noaa/AirMassRGB/FD/1808/$image'," >> "$JS_FILE"
done < image_list.txt
